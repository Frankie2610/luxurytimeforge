...
const checks=[
  ...
  ['iframe không khởi động trạng thái auth loading',auth.includes('useState(firebaseAppEnabled&&!previewFrame&&authRequired)')],
  ['iframe không đăng ký Firebase auth observer',auth.includes('if(previewFrame||!firebaseAppEnabled||!authRequired){setLoading(false);return}')],
