...
const checks = [
  ...
  ['Footer renders the editable resolved store name', (storefront.includes('const storeName=resolveStoreName(settings.storeName)') || storefront.includes('const storeName=resolveStoreName(identity.storeName)')) && storefront.includes('tf564-footer-store-name') && admin.includes('Tên này đồng bộ lên header, footer')],
