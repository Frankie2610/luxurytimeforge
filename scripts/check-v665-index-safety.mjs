...
const packageJson=JSON.parse(pkg);must(/^(?:0\.66\.(?:5|6)|0\.67\.0)$/.test(packageJson.version)&&packageJson.scripts?.build?.includes('check-v665-index-safety.mjs'),'package/build pipeline includes index safety check');
